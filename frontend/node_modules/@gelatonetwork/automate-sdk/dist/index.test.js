...
const iceCreamInterface = new ethers_1.ethers.utils.Interface(iceCreamAbi);
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sdk = new lib_1.AutomateSDK(chainId, wallet);
    const taskId = yield sdk.createTask({
        ...
        singleExec: true,
        startTime: (yield provider.getBlock("latest")).timestamp + 300,
    });
    console.log(taskId);
});
main()

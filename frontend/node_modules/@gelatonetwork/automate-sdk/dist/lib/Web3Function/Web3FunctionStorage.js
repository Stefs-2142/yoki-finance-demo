...
exports.Web3FunctionStorage = void 0;
const axios_1 = __importDefault(require("axios"));
const constants_1 = require("../../constants");
const utils_1 = require("../../utils");
class Web3FunctionStorage {
    ...
    get(chainId, taskId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const res = yield this._userApi.get(`/users/${address}/web3-function-storage/${chainId}/${taskId}`, { headers: { Authorization: `Bearer ${authToken}` } });
                return res.data;
            }
            catch (err) {
...
exports.Web3FunctionStorage = Web3FunctionStorage;
